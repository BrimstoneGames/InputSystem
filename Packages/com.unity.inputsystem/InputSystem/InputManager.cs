...
using System.Linq;
using InputSystem.OldInputCompatibility;
...
namespace UnityEngine.InputSystem
{
    ...
    internal class InputManager
    {
        ...
        internal void Initialize(IInputRuntime runtime, InputSettings settings)
        {
            ...
            OldInputCompatibility.BootstrapInputConfiguration();
            OldInputCompatibility.Enable();
        }

        internal void Destroy()
        {
            // TODO find a better place
            OldInputCompatibility.Disable();
        ...
        private unsafe void OnUpdate(InputUpdateType updateType, ref InputEventBuffer eventBuffer)
        {
            ...
            OldInputCompatibility.OnUpdate();
