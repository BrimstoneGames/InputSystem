...
namespace UnityEngine
{
    ...
    public class Gyroscope
    {
        ...
        private static Vector3 rotationRate_Internal(int idx) {return Vector3.zero;}
        private static Vector3 rotationRateUnbiased_Internal(int idx) {return Vector3.zero;}
        private static Vector3 gravity_Internal(int idx) {return Vector3.zero;}
        private static Vector3 userAcceleration_Internal(int idx) {return Vector3.zero;}
        private static Quaternion attitude_Internal(int idx) {return Quaternion.identity;}
        private static bool getEnabled_Internal(int idx) { return false; }
        private static void setEnabled_Internal(int idx, bool enabled) {}
        private static float getUpdateInterval_Internal(int idx) {return 0.0f;}
    ...
    public class LocationService
    {
        ...
        internal static bool IsServiceEnabledByUser() {return false;}
        internal static LocationServiceStatus GetLocationStatus() {return LocationServiceStatus.Stopped;}
        internal static LocationInfo GetLastLocation() {return new LocationInfo();}
        ...
        internal static HeadingInfo GetLastHeading() {return new HeadingInfo();}
        internal static bool IsHeadingUpdatesEnabled() {return false;}
    ...
    public class Input
    {
        private static bool GetKeyInt(KeyCode key) {return false;}
        private static bool GetKeyString(string name) {return false;}
        private static bool GetKeyUpInt(KeyCode key) {return false;}
        private static bool GetKeyUpString(string name) {return false;}
        private static bool GetKeyDownInt(KeyCode key) {return false;}
        private static bool GetKeyDownString(string name) {return false;}
        public static float GetAxis(string axisName) {return 0.0f;}
        public static float GetAxisRaw(string axisName) {return 0.0f;}
        ...
        private static int GetGyroInternal() {return 0;}
